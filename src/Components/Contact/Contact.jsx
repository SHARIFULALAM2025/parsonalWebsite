...
const Contact = () => {
  ...
  return (
    <div id="contact" className="w-full">
      <section style={bgStyle} className="py-12 lg:py-24 px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <motion.div
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20">
            ...
            {contactInfo.map((info, index) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-white text-xs sm:text-sm break-all lg:break-normal">
                    {info.value}
                  </p>
                </div>
              </motion.a>
          ...
          >
            ...
            <form onSubmit={handleSubmit(handelData)} className="space-y-5">
              ...
              <div className="w-full">
                <label className="block mb-2 text-xs font-medium text-white uppercase tracking-wider">

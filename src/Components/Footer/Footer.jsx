        ...
        >
          ...
          <motion.div variants={fadeInUp}>
              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <motion.a
                    ...
                    whileHover={{ scale: 1.2 }}
                    className={`w-12 h-12 bg-gray-800 ${social.bg} text-white rounded-2xl flex items-center justify-center transition`}
            ...
            <div className="text-sm text-white space-y-1">
              ...
              <p className="flex items-center gap-3">
                <HiLocationMarker></HiLocationMarker>Uttara
                Sector-13,Road-5,House:65 Dhaka -Bangladesh
              </p>
            </div>
          </motion.div>
        </motion.div>

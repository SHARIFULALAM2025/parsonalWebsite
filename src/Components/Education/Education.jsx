  ...
  return (
    <section style={bgStyle} id="education" className="section-padding">
      <div className="container-custom">
        ...
        >
          <motion.h2
            className="text-4xl lg:text-5xl font-bold text-white dark:text-gray-100 mb-4"
            variants={fadeInUp}
          >
                ...
                <div className="p-6">
                  ...
                  <ul className="space-y-2">
                    {edu.achievements.map((item, i) => (
                      <motion.li
                        key={i}
                        className="text-sm text-white flex items-start gap-3"
                        variants={fadeInUp}
                      >
              ...
              >
                ...
                <div className={`p-6 bg-gradient-to-r ${exp.color}`}>
                  ...
                  <div className="flex flex-wrap gap-4 mt-3 text-sm text-white">
                    ...
                    <span className="bg-white/2 px-2 py-0.5 rounded-full text-xs">
                      {exp.type}
                    </span>
                  </div>
                </div>
